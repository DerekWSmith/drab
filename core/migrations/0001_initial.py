# Generated by Django 4.2.21 on 2025-06-06 00:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, help_text='User who created the task', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities_created', to=settings.AUTH_USER_MODEL)),
                ('creator', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_items', to=settings.AUTH_USER_MODEL)),
                ('next_responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_next_responsible_items', to=settings.AUTH_USER_MODEL)),
                ...
                ('previous', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_superseded_by', to='core.activity')),
                ('requisites', models.ManyToManyField(blank=True, related_name='complete_with_tasks', to='core.activity')),
                ('responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_responsible_items', to=settings.AUTH_USER_MODEL)),
                ...
                ('updated_by', models.ForeignKey(blank=True, db_constraint=False, help_text='User who last updated the task', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities_updated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quorum', models.PositiveIntegerField(blank=True, default=0)),
                ('majority', models.PositiveIntegerField(blank=True, default=0)),
                ('tags', models.CharField(blank=True, db_index=True, default='', max_length=250)),
                ('activities', models.ManyToManyField(blank=True, related_name='%(class)s_related_items', to='core.activity')),
                ('admins', models.ManyToManyField(blank=True, related_name='%(class)s_administers_items', to=settings.AUTH_USER_MODEL)),
                ('creator', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_items', to=settings.AUTH_USER_MODEL)),
                ('mandatory_voters', models.ManyToManyField(blank=True, related_name='mandatory_vote_decisions', to=settings.AUTH_USER_MODEL)),
                ('next_responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_next_responsible_items', to=settings.AUTH_USER_MODEL)),
                ('previous', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_superseded_by', to='core.decision')),
                ('responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_responsible_items', to=settings.AUTH_USER_MODEL)),
                ('subscribers', models.ManyToManyField(related_name='%(class)s_subscribed_items', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_items', to=settings.AUTH_USER_MODEL)),
                ('next_responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_next_responsible_items', to=settings.AUTH_USER_MODEL)),
                ('previous', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_superseded_by', to='core.brief')),
                ('responsible', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_responsible_items', to=settings.AUTH_USER_MODEL)),
                ('subscribers', models.ManyToManyField(related_name='%(class)s_subscribed_items', to=settings.AUTH_USER_MODEL)),
            ],
            options={
