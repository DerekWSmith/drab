"""
Django settings for drrbb project.
...
SECRET_KEY = 'django-insecure-o^t(_so!k#+7hltu7#^9_3xg-p*n_sonjifa=l()(k(q(8bcvh'
...
WSGI_APPLICATION = 'drrbb.wsgi.application'
